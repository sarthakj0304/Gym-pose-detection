        ...
        if exercise_running and current_exercise:
            ...
            if results.pose_landmarks:
                ...
                if current_exercise_data['type'] == "squat":
                    (counter, angle, stage, ml_label, ml_confidence) = current_exercise.track_squat(results.pose_landmarks.landmark, frame)
                    ...
                    (counter, angle, stage, ml_label, ml_confidence) = current_exercise.track_push_up(results.pose_landmarks.landmark, frame)
                    layout_indicators(frame, current_exercise_data['type'], (counter, angle, stage))
                    exercise_counter = counter
                    ...
                    ml_label, ml_confidence) = current_exercise.track_hammer_curl(
